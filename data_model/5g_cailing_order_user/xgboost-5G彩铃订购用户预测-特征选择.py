...
def featureChose(trainFilePath,testFilePath):
    labels = ['flag']
    label = 'flag'
    ...
    # 设置所有参与分析的特征
    x_feature_params = ['prov_id', 'cust_sex', 'cert_age', 'total_fee', 'jf_flux', 'fj_arpu', 'ct_voice_fee', 'total_flux', 'total_dura', 'roam_dura','total_times',
                        'total_nums', 'local_nums', 'roam_nums', 'in_cnt', 'out_cnt', 'in_dura','out_dura', 'visit_cnt', 'visit_dura', 'up_flow', 'down_flow', 'total_flow',
                        'imei_duration', 'avg_duratioin', 'brand_flag', 'heyue_flag', 'is_limit_flag','product_type', '5g_flag', 'active_days', 'service_type']  ## 'app_type_id', 'app_visit_dura'
...
if __name__ == '__main__':
    ...
    featureChose(trainFilePath,test_path)